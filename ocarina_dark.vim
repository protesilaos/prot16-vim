...
hi Todo gui=bold guibg=#313C3D guifg=#2AA2A5 cterm=bold ctermbg=0 ctermfg=4
...
hi CursorLineNr gui=bold guibg=#313C3D guifg=#9B9B97 cterm=bold ctermbg=0 ctermfg=12
