...
hi Todo gui=bold guibg=#5A4648 guifg=#479CB5 cterm=bold ctermbg=0 ctermfg=4
...
hi CursorLineNr gui=bold guibg=#5A4648 guifg=#8F8082 cterm=bold ctermbg=0 ctermfg=12
