...
hi Todo gui=bold guibg=#202D14 guifg=#5A5DA8 cterm=bold ctermbg=0 ctermfg=4
...
hi CursorLineNr gui=bold guibg=#202D14 guifg=#7F8D64 cterm=bold ctermbg=0 ctermfg=12
