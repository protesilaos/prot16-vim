...
hi Todo gui=bold guibg=#383C46 guifg=#A97552 cterm=bold ctermbg=0 ctermfg=1
...
hi CursorLineNr gui=bold guibg=#383C46 guifg=#808188 cterm=bold ctermbg=0 ctermfg=12
