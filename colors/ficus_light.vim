...
hi Todo gui=bold guibg=#DDE1D5 guifg=#6D75CD cterm=bold ctermbg=7 ctermfg=4
...
hi CursorLineNr gui=bold guibg=#DDE1D5 guifg=#67556C cterm=bold ctermbg=7 ctermfg=11
