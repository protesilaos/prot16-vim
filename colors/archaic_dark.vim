...
hi Todo gui=bold guibg=#3E3936 guifg=#8A6BB5 cterm=bold ctermbg=0 ctermfg=13
...
hi CursorLineNr gui=bold guibg=#3E3936 guifg=#9E9178 cterm=bold ctermbg=0 ctermfg=12
