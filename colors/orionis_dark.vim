...
hi Todo gui=bold guibg=#2F3A3D guifg=#974F6C cterm=bold ctermbg=0 ctermfg=1
...
hi CursorLineNr gui=bold guibg=#2F3A3D guifg=#8F9193 cterm=bold ctermbg=0 ctermfg=12
