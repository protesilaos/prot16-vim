...
hi Warning gui=none guibg=#9A813D guifg=#F1E2CD cterm=none ctermbg=3 ctermfg=15
hi Error gui=none guibg=#985637 guifg=#F1E2CD cterm=none ctermbg=1 ctermfg=15
...
hi CursorLineNr gui=none guibg=#2A3235 guifg=#A1927D cterm=none ctermbg=0 ctermfg=12
...
hi DiffDelete gui=none guibg=#985637 guifg=#F1E2CD ctermbg=1 cterm=none ctermfg=15
hi DiffChange guibg=#9D6A47 guifg=#F1E2CD ctermbg=9 ctermfg=15
hi DiffText gui=none guibg=#A3636D guifg=#F1E2CD cterm=none ctermbg=5 ctermfg=15
