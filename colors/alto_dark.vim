...
hi Todo gui=bold guibg=#283D3A guifg=#C9753D cterm=bold ctermbg=0 ctermfg=9
...
hi CursorLineNr gui=bold guibg=#283D3A guifg=#8A8A7C cterm=bold ctermbg=0 ctermfg=12
