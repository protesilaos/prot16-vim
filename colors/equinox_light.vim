...
hi Todo gui=bold guibg=#ECEAEE guifg=#CC5D9A cterm=bold ctermbg=7 ctermfg=5
...
hi CursorLineNr gui=bold guibg=#ECEAEE guifg=#7D7981 cterm=bold ctermbg=7 ctermfg=11
