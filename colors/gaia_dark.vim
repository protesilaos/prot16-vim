...
hi StatusLine gui=none,bold guibg=#3d3e3f guifg=#94ae9f cterm=none,bold ctermbg=8 ctermfg=14
hi StatusLineNC gui=none guibg=#3d3e3f guifg=#5B6c4a cterm=none ctermbg=8 ctermfg=10
hi VertSplit gui=none cterm=none
hi TabLine gui=none guibg=#3d3e3f guifg=#786c4d cterm=none ctermbg=8 ctermfg=11
...
hi Todo gui=none guibg=#3d3e3f guifg=#6c9cba cterm=none ctermbg=8 ctermfg=4
...
hi Float guifg=#a9880b ctermfg=9
hi Label guifg=#7c8e2d ctermfg=2
...
hi CursorLine gui=none guibg=#3d3e3f cterm=none ctermbg=8
hi CursorLineNr gui=none guibg=#3d3e3f guifg=#7b8d9d cterm=none ctermbg=8 ctermfg=12
hi ColorColumn guibg=#786c4d ctermbg=11

hi Folded guibg=#3d3e3f guifg=#ebeddf ctermbg=8 ctermfg=15
hi FoldColumn guibg=#3d3e3f guifg=#ebeddf ctermbg=8 ctermfg=15
hi SignColumn guibg=#3d3e3f guifg=#ebeddf ctermbg=8 ctermfg=15
